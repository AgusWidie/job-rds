...
<html lang="en">
	...
	<script>
		...
		function LoadDataWarranty() {
			...
			$.ajax({
				...
				success: function (dataJson) {
					...
					//alert(dataJson.data[0].activationCode);
					if (dataJson.error == false) {
							
						document.getElementById("ActivationCode").value = dataJson.data[0].activationCode;
						document.getElementById("ProductNumber").value = dataJson.data[0].productCode;
						document.getElementById("SerialNumber").value = dataJson.data[0].serialCode;
						document.getElementById("ProductName").value = "";
						document.getElementById("RegistrationCode").value = dataJson.data[0].registrationCode;
		...
		function SaveDataWarranty() {
			
			var url = "https://localhost:7214/api/Warranty/AddWarranty";
			...
			if(RegistrationCode == null || RegistrationCode == "") {
				Swal.fire({
					title: "Data Warranty",
					text: "Data Registration Code Kosong.",
					icon: "warning"
				});
				return;
			}
			...
			if(CustomerName == null || CustomerName == "") {
				Swal.fire({
					title: "Data Warranty",
					text: "Data Nama Customer Kosong.",
					icon: "warning"
				});
				return;
			}
			...
			if(SerialNumber == null || SerialNumber == "") {
				Swal.fire({
					title: "Data Warranty",
					text: "Data Serial Number Kosong.",
					icon: "warning"
				});
				return;
			}
